...
#docker build --build-arg PASSWORD="Always compare password hashes using constant-time comparison" --build-arg PASSWORD_FILE="/opt/crypto-lab/password.db" --build-arg MODE=plaintext --build-arg HTTPS=True -t lab3_server .
